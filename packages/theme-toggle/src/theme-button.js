  ...
  const func = (root, initTheme, changeTheme) => {
    ...
    components.onclick = () => {
      if (isMoved) {
        ...
        changeTheme({ theme: "light", transitionDuration: 1000 });
      } else {
