  ...
  const func = (root, initTheme, changeTheme) => {
    ...
    components.onclick = () => {
      if (isMoved) {
        ...
        mainButton.style.transform = "translateX(210em)";
        ...
        daytimeBackground[0].style.transform = "translateX(210em)";
        daytimeBackground[1].style.transform = "translateX(155em)";
        daytimeBackground[2].style.transform = "translateX(100em)";
    ...
    mainButton.addEventListener("mousemove", function () {
      ...
      if (isMoved) {
        mainButton.style.transform = "translateX(196em)";
        daytimeBackground[0].style.transform = "translateX(196em)";
        daytimeBackground[1].style.transform = "translateX(141em)";
        daytimeBackground[2].style.transform = "translateX(88em)";
        ...
        mainButton.style.transform = "translateX(16em)";
        daytimeBackground[0].style.transform = "translateX(16em)";
        daytimeBackground[1].style.transform = "translateX(12em)";
        daytimeBackground[2].style.transform = "translateX(7em)";
