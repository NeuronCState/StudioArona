import { MessageCircle, Rss, Users, Server, Cpu, User, HardDrive } from 'lucide-react';
  ...
  return (
    <nav className="flex w-16 flex-col items-center border-r border-border bg-surface-raised py-4">
      <div className="mb-6 flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl">
        <img src="/208.jpg" alt="Arona" className="h-full w-full object-cover" />
      </div>
      ...
      <div className="flex flex-col items-center gap-3">
        <div className={cn('h-2 w-2 rounded-full', statusColor)} title={`状态: ${wakeState}`} />
