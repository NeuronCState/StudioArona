    ...
    unsubs.push(
      onUIAction('live2d.play_motion', (action: UIAction) => {
        if (action.type === 'live2d.play_motion') {
          const entry = spine.state.setAnimation(TRACK_BODY, action.motion, false);
    ...
    unsubs.push(
      onUIAction('live2d.set_emotion', (action: UIAction) => {
        if (action.type === 'live2d.set_emotion') {
          ...
          const faceEntry = spine.state.setAnimation(TRACK_EXPRESSION, m.expression, true);
          faceEntry.mixDuration = 0.2;
          if (m.body) {
            const bodyEntry = spine.state.setAnimation(TRACK_BODY, m.body, false);
