...
export function ThinkingBlock({ content, done, defaultOpen = false }: ThinkingBlockProps) {
  ...
  return (
    ...
    >
      <button
        ...
        aria-expanded={open}
      >
        <Brain size={12} className={done ? 'text-stone-400' : 'animate-pulse text-amber-500'} />
