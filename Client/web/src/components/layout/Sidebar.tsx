import { Home, Rss, Cpu, Server, Brain, Calendar, PanelLeftClose } from 'lucide-react';
        ...
        <div className="flex items-center gap-2.5">
          {isStudio ? (
            <>
              ...
              <div>
                <span className="block text-sm font-semibold text-[var(--color-text-primary)]" style={{ fontFamily: 'var(--font-serif, serif)' }}>
                  Studio301
                </span>
                <span className="block text-[10px] uppercase tracking-[0.16em] text-[var(--color-text-muted)]">Workbench</span>
              </div>
            </>
          ) : (
            <>
              ...
              <div>
                ...
                <span className="block text-[10px] uppercase tracking-[0.18em] text-[var(--color-text-muted)]">Command Center</span>
              </div>
            </>
          )}
        </div>
                ...
                cn(
                  ...
                  isStudio
                    ? cn(
                        ...
                        isActive && 'bg-[var(--color-accent-soft)] text-[var(--color-accent)] font-semibold',
                    ...
                    : cn(
                        ...
                        isActive && 'bg-white/80 text-[var(--color-arona-deep)] font-semibold shadow-[var(--shadow-1)]',
                        !isActive && 'text-[var(--color-text-secondary)]',
                      ),
                )
              }
      ...
      <div className="border-t border-[var(--color-border)] px-3 py-2.5">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[10px] text-[var(--color-text-muted)]">{statusLabel}</p>
          </div>
        </div>
      </div>
    </aside>
