...
export function XTermTerminal({
  ...
  useEffect(() => {
    ...
    if (mockMode) {
      ...
      term.writeln(
        `\x1b[2mHost: ${host ?? "localhost"}:${port ?? "N/A"}\x1b[0m`,
      );
      term.writeln("");
      ...
      const mockCommands: Record<string, string | (() => void)> = {
        ...
        "nvidia-smi": () => {
          ...
          term.writeln(
            "|   0  NVIDIA V100 16GB               On  |   00000000:00:1E.0 Off |                    0 |",
          );
          term.writeln(
            "| N/A   72C    P0             95W / 250W |    8192MiB / 16384MiB |      85%      Default |",
          );
          term.writeln(
            "|                                         |                        |                  N/A |",
          );
        ...
        python: () => {
          term.writeln(
            "Python 3.12.4 (main, Jun 15 2026, 10:23:45) [GCC 11.4.0]",
          );
